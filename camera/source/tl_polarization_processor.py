...
class PolarizationProcessorSDK(object):
    ...
    def create_polarization_processor(self):
        ...
        :returns: :ref:`PolarizationProcessor<Ref-PolarizationProcessor>`
...
class PolarizationProcessor(object):
    ...
    call its :ref:`dispose<Ref-PolarizationProcessor-dispose>` method to clean up any opened resources. These object can
    be managed using *with* statements for automatic resource clean up. These objects can only be created by calls to
    :ref:`PolarizationProcessorSDK.create_polarization_processor()<Ref-PolarizationProcessorSDK-create_polarization_processor>`
    ...
    def transform_to_intensity(self,
        ...
        :param image_origin_x_pixels: The X position of the origin (top-left) of the input image on the sensor. Warning: Some camera models may nudge input ROI values. Please read values back from camera. See :ref:`TLCamera.roi<Ref-TLCamera-roi>`.
        :param image_origin_y_pixels: The Y position of the origin (top-left) of the input image on the sensor. Warning: Some camera models may nudge input ROI values. Please read values back from camera. See :ref:`TLCamera.roi<Ref-TLCamera-roi>`.
